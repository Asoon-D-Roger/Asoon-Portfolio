...
const skills = {
  title: "My Skills",
  description: "Versatile Python Full-Stack Developer proficient in Django, React, and cloud services, with a proven ability to deliver robust, scalable web applications and optimize performance.",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "HTML 5",
